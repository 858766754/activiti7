...
public class DemoApplication2 implements CommandLineRunner {
	...
	private Logger logger = LoggerFactory.getLogger(DemoApplication2.class);
	...
	public void run(String... args) {
		...
		taskRuntime.create(TaskPayloadBuilder.create().withName("First Team Task")
				.withDescription("This is something really important").withCandidateGroup("activitiTeam")
